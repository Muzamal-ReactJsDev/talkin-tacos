...
// // ya wo wala function ha jis ma hum order now ko cart-items ma change krty hain....
...
//                 <button className="navbar-search-button w-100">
//                   {isMenuPage ? `Cart Items: ${count.length}` : "Order Now"}
//                 </button>
//               </div>
//             </nav>
//             <div className={isSidebarOpen ? "sidebar open" : "sidebar"}>
...
// here i convert the Login into logout after login....

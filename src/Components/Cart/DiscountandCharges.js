...
//   return (
//     <>
//       <Container className="nnnn" style={{ color: "white" }}>
//         <Row>
//           <Col xs={12}>
//             <Box sx={{ width: "100%" }}>
//               <Box>
...
//   );
// }
///////////////////////// set the localStorage of caretColor:
...
export default function BasicTabs() {
  ...
  useEffect(() => {
    // ... (existing logic for fetching data and calculating percentages)

    const totalPriceAfterTax = calculateTotalAmount(); // Calculate total amount

    // Update localStorage with calculateTotalAmount() instead of totalPrice
    localStorage.setItem("totalPriceAfterTax", totalPriceAfterTax);
  }, [deliveryOption, totalPrice]); // Add relevant dependencies
